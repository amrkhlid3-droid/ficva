...
export class BringToFrontCommand implements Command {
  ...
  execute() {
    ...
    console.log(`[BringToFront] Moving object ${this.object.type} from ${this.originalIndex} to ${maxIndex}`)
  ...
  undo() {
    console.log(`[BringToFront:Undo] Moving object ${this.object.type} back to ${this.originalIndex}`)
