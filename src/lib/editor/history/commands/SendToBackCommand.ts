...
export class SendToBackCommand implements Command {
  ...
  execute() {
    console.log(`[SendToBack] Moving object ${this.object.type} from ${this.originalIndex} to 0`)
  ...
  undo() {
    console.log(`[SendToBack:Undo] Moving object ${this.object.type} back to ${this.originalIndex}`)
