...
ALTER TABLE "user_device" ADD CONSTRAINT "user_device_userId_user_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;